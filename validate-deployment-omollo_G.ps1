...
Check-File "backend/tastybites/requirements.txt"
Check-File "backend/tastybites/manage.py"
Check-File "backend/tastybites/tastybites/settings.py"
...
$settingsContent = Get-Content "backend\tastybites\tastybites\settings.py" -Raw
...
$reqContent = Get-Content "backend\tastybites\requirements.txt" -Raw
