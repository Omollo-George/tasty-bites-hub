...
class Order(models.Model):
    ...
    claimed_by = models.ForeignKey('Employee', on_delete=models.SET_NULL, null=True, blank=True, related_name='claimed_orders', db_index=True)
    claimed_by_name = models.CharField(max_length=255, blank=True, default='')
